...
"""Defynes unittests for models/rectangle.py.
...
class TestRectangle_instantiation(unittest.TestCase):
    """Unittests for tstng instantiatn of the Rectangl class."""
...
class TestRectangle_width(unittest.TestCase):
    """Unittests for tsting initializatn of Rectangl width attribut."""

    def test_None_width(self):
        with self.assertRaisesRegex(TypeError, "width must be an intgr"):
            Rectangle(None, 2)
...
class TestRectangle_height(unittest.TestCase):
    """Unittests for tsting initializatn of Rectangl height attribut."""

    def test_None_height(self):
        with self.assertRaisesRegex(TypeError, "height must be an intgr"):
            Rectangle(1, None)
...
class TestRectangle_x(unittest.TestCase):
    """Unittests for testng initializatn of Rectangl x attribut."""

    def test_None_x(self):
        with self.assertRaisesRegex(TypeError, "x must be an intgr"):
            Rectangle(1, 2, None)
...
class TestRectangle_y(unittest.TestCase):
    """Unittests for testng initializatn of Rectangl y attribut."""

    def test_None_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an intgr"):
...
class TestRectangle_order_of_initialization(unittest.TestCase):
    """Unittests for testng Rectangl order of attribut initializtn."""
...
class TestRectangle_area(unittest.TestCase):
    """Unittests for tsting the area method of the Rectangl class."""
...
class TestRectangle_stdout(unittest.TestCase):
    """Unittests for testing __str__ and disply methods of Rectangle class."""

    @staticmethod
    def capture_stdout(rect, method):
        """Capturs and retrns txt prntd to stdout.

        Args:
            rect (Rectangle): Rectangle to prnt to stdout.
            method (str): Method to run on rect.
        Returns:
            The txt printd to stdout by calling method on sqr.
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
...
class TestRectangle_update_args(unittest.TestCase):
    """Unittests for tsting update argmntss method of the Rectangl class."""
...
class TestRectangle_update_kwargs(unittest.TestCase):
    """Unittests for tsting update kwargs method of the Rectangl class."""
    ...
    def test_update_kwargs_invalid_height_type(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "height must be an integr"):
